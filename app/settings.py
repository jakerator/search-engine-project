...
SECRET_KEY = 'django-insecure-lqg(1y(ahznlyx2lwgx7k0ds85xe9bma+#9avqkz4atq86eg84'
...
# Update database configuration from $DATABASE_URL environment variable if it exists
